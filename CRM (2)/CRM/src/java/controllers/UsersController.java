        ...
        switch (op) {
            case "update":
                try {
                    ...
                    Users users = new Users(id, email, password, fullname, avatar, status, role_id);
                    ur.update(users);
        ...
        switch (op) {
            case "create":
                try {
                    ...
                    int status = Integer.parseInt(request.getParameter("status"));
                    int role_id = Integer.parseInt(request.getParameter("role_id"));
                    Users users = new Users(email, password, fullname, avatar, status, role_id);
                    request.setAttribute("users", users);
                    ur.create(users);
                    response.sendRedirect(request.getContextPath() + "/users/listOf.do");
                } catch (Exception ex) {
